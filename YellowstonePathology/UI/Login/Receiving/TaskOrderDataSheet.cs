...
namespace YellowstonePathology.UI.Login.Receiving
{
    public class TaskOrderDataSheet
    {
		...
		private void SetTaskGrid()
		{
			...
			string userName = Business.User.SystemUserCollectionInstance.Instance.SystemUserCollection.GetSystemUserById(this.m_TaskOrder.OrderedById).DisplayName;
			this.WriteData(grid, 0, 5, "Ordered By:", userName);			           
