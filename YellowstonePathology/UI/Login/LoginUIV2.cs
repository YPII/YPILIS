...
namespace YellowstonePathology.UI.Login
{
	public class LoginUIV2 : INotifyPropertyChanged
	{
        ...
        {
            this.m_ReportSearchList = YellowstonePathology.Business.Gateway.ReportSearchGateway.GetReportSearchListBySVHPosted(postDate);
            this.NotifyPropertyChanged("ReportSearchList");
        }

        public void GetReportSearchListByQICases()
        {
            this.m_ReportSearchList = YellowstonePathology.Business.Gateway.ReportSearchGateway.GetReportSearchListByQICases();
            this.NotifyPropertyChanged("ReportSearchList");
        }
        ...
        {
            this.m_ReportSearchList = YellowstonePathology.Business.Gateway.ReportSearchGateway.GetReportSearchListByInvalidFinal();
            this.NotifyPropertyChanged("ReportSearchList");
        }
