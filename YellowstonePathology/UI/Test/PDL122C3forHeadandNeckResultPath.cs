...
{
    public class PDL122C3forHeadandNeckResultPath : ResultPath
    {
        PDL122C3forHeadandNeckResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3forHeadandNeck.PDL122C3forHeadandNeckTestOrder m_PanelSetOrder;

        public PDL122C3forHeadandNeckResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3forHeadandNeck.PDL122C3forHeadandNeckTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL122C3forHeadandNeckResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL122C3forHeadandNeckResultPage.NextEventHandler(ResultPage_Next);
