...
{
    public class PDL122C3forUrothelialCarcinomaResultPath : ResultPath
    {
        PDL122C3forUrothelialCarcinomaResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3forUrothelialCarcinoma.PDL122C3forUrothelialCarcinomaTestOrder m_PanelSetOrder;

        public PDL122C3forUrothelialCarcinomaResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3forUrothelialCarcinoma.PDL122C3forUrothelialCarcinomaTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL122C3forUrothelialCarcinomaResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL122C3forUrothelialCarcinomaResultPage.NextEventHandler(ResultPage_Next);
