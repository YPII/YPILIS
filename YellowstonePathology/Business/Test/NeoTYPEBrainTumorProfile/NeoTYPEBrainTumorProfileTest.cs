...
namespace YellowstonePathology.Business.Test.NeoTYPEBrainTumorProfile
{
    public class NeoTYPEBrainTumorProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
...
this.m_ImplementedResultTypes.Add(Business.Test.ResultType.REFLAB);
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("88377", null), 6);
