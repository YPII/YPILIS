...
{
	public class HER2AmplificationByISHEPICBeakerObxView : YellowstonePathology.Business.HL7View.EPIC.EPICBeakerObxView
    {
		public HER2AmplificationByISHEPICBeakerObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
		...
		public void BreastToXml(XElement document, HER2AmplificationByISHTestOrder panelSetOrder)
        {
            ...
            this.AddNextObxElementBeaker("HER2", panelSetOrder.Result, document, "F");
            this.AddNextObxElementBeaker("Ratio", panelSetOrder.AverageHer2Chr17Signal, document, "F");
            this.AddNextObxElementBeaker("Average HER2 Copy Number", panelSetOrder.AverageHer2NeuSignal.Value.ToString(), document, "F");
            ...
            this.AddNextObxElementBeaker("Number of invasive tumor cells counted", panelSetOrder.CellsCounted.ToString(), document, "F");
            this.AddNextObxElementBeaker("Number of observers", panelSetOrder.NumberOfObservers.ToString(), document, "F");
            if (panelSetOrder.AverageHer2NeuSignal.HasValue == true)
            {
                this.AddNextObxElementBeaker("HER2 average copy number", panelSetOrder.AverageHer2NeuSignal.Value.ToString(), document, "F");
            }
            this.AddNextObxElementBeaker("Chr17 average copy number", panelSetOrder.AverageChr17Signal, document, "F");
            this.AddNextObxElementBeaker("Ratio of average HER2/Chr17 signals", panelSetOrder.AverageHer2Chr17Signal, document, "F");
            ...
            this.AddNextObxElementBeaker("Specimen site and type", specimenOrder.Description + blockDescription, document, "F");
            ...
            this.AddNextObxElementBeaker("Duration of fixation", specimenOrder.FixationDurationString, document, "F");
            this.AddNextObxElementBeaker("Sample adequacy", panelSetOrder.SampleAdequacy, document, "F");

            string collectionDateTimeString = YellowstonePathology.Business.Helper.DateTimeExtensions.CombineDateAndTime(specimenOrder.CollectionDate, specimenOrder.CollectionTime);
            this.AddNextObxElementBeaker("Collection Date/Time", collectionDateTimeString, document, "F");
            
            this.AddNextObxElementBeaker("Interpretation", panelSetOrder.InterpretiveComment, document, "F");
            this.AddNextObxElementBeaker("Reference Range", referenceRange, document, "F");
            ...
            this.AddNextObxElementBeaker("References", panelSetOrder.ReportReference, document, "F");
        ...
        private void ASCOCAP2018(XElement document, HER2AmplificationByISHTestOrder panelSetOrder)
        {
            ...
            this.AddNextObxElementBeaker("HER2 Gene Amplification", panelSetOrder.PanelSetName, document, "F");

            this.AddNextObxElementBeaker("HER2", panelSetOrder.Result, document, "F");
            this.AddNextObxElementBeaker("HER2 to Chr17 Ratio", panelSetOrder.AverageHer2Chr17Signal, document, "F");
            this.AddNextObxElementBeaker("Average HER2 Copy Number", panelSetOrder.AverageHer2NeuSignal.Value.ToString(), document, "F");
