...
{
    public class HER2AmplificationByISHWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public HER2AmplificationByISHWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
