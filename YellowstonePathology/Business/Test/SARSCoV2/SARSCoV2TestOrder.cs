...
namespace YellowstonePathology.Business.Test.SARSCoV2
{
	...
	{                
		...
		{            
            ...
            this.m_ASRComment = "The test was performed using the N1 probe from the FDA emergency authorized CDC kit.  The FDA procedure was performed using a modified RNA extraction method for test optimization, and the modified procedure was validated by Yellowstone Pathology Institute (YPI).  YPI assumes the responsibility for test performance.  This laboratory is certified under the Clinical Laboratory Improvement Amendments of 1988 (CLIA-88) as qualified to perform high complexity clinical laboratory testing";            
        }
