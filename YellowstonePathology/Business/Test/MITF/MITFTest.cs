...
namespace YellowstonePathology.Business.Test.MITF
{
    public class MITFTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public MITFTest()
        {
            this.m_PanelSetId = 352;
            this.m_PanelSetName = "MITF";
            this.m_Abbreviation = "MITF";
