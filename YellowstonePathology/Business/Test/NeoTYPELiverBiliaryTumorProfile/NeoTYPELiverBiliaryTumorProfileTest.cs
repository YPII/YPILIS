...
namespace YellowstonePathology.Business.Test.NeoTYPELiverBiliaryTumorProfile
{
    public class NeoTYPELiverBiliaryTumorProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
