...
namespace YellowstonePathology.Business.Test.PAX2
{
    public class PAX2Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public PAX2Test()
        {
            this.m_PanelSetId = 350;
            this.m_PanelSetName = "PAX2";
            this.m_Abbreviation = "PAX2";
