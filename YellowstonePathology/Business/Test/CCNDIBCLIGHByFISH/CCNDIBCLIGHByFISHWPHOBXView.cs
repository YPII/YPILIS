...
{
    public class CCNDIBCLIGHByFISHWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public CCNDIBCLIGHByFISHWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
