...
namespace YellowstonePathology.Business.Test.DNMT3AMutationAnalysis
{
    public class DNMT3AMutationAnalysisTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public DNMT3AMutationAnalysisTest()
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode1 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81403", null), 1);
