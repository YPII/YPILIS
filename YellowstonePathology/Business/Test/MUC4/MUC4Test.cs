...
namespace YellowstonePathology.Business.Test.MUC4
{
    public class MUC4Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public MUC4Test()
        {
            this.m_PanelSetId = 398;
            this.m_PanelSetName = "MUC4 (IHC)";
            this.m_Abbreviation = "MUC4";
