...
{
	public class SurgicalNMHOBXViewOld : Business.HL7View.NMH.NMHOBXViewOld
	{
		public SurgicalNMHOBXViewOld(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
