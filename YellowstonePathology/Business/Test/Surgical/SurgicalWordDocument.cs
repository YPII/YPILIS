...
namespace YellowstonePathology.Business.Test.Surgical
{
    public class SurgicalWordDocument : YellowstonePathology.Business.Document.CaseReportV2
    {
        ...
        public override void Render()
        {
            ...
            this.m_TemplateName = @"\\Cfileserver\Documents\ReportTemplates\XmlTemplates\Surgical.4.xml";
        ...
        private bool SpecimenHasERPR(YellowstonePathology.Business.Specimen.Model.SpecimenOrder specimenOrder)
        {
            bool result = false;
