...
{
	public class SurgicalNMHObxViewOLD2 : YellowstonePathology.Business.HL7View.NMH.NMHOBXView
	{
		public SurgicalNMHObxViewOLD2(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
		...
		public override void ToXml(XElement document)
		{
            ...
            //OBX | 1 | TX | FD ^ Final Diagnosis ^ L |
            //OBX | 2 | TX | GD ^ Gross Description ^ L |
            //OBX | 3 | TX | MD ^ Microscopic Description ^ L

            this.AddNextObxElementV2("FD", "Final Diagnosis", "The diagnosis doesnt look so good.", document, "F");
            this.AddNextObxElementV2("GD", "Gross Description", "Things look gross", document, "F");
            this.AddNextObxElementV2("MD", "Microscopic Description", "Thinds look very small", document, "F");
            ...
            */
            ...
            string pdfFileName = Business.Document.CaseDocument.GetCaseFileNamePDF(new OrderIdParser(this.m_ReportNo));
            this.AddPDFSegments(pdfFileName, document);
        }
