...
{
	public class SurgicalDeerLodgeNteView : YellowstonePathology.Business.HL7View.DeerLodge.DeerLodgeNteView
	{
        protected YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        protected string m_DateFormat = "yyyyMMddHHmm";
        protected string m_ReportNo;

		public SurgicalDeerLodgeNteView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo)
		{
