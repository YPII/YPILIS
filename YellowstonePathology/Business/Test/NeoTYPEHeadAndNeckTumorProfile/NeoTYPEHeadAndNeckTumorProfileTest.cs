...
namespace YellowstonePathology.Business.Test.NeoTYPEHeadAndNeckTumorProfile
{
    public class NeoTYPEHeadAndNeckTumorProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeoTYPEHeadAndNeckTumorProfileTest()
        {
            this.m_PanelSetId = 382;
            this.m_PanelSetName = "NeoTYPE Head & Neck Tumor Profile";
