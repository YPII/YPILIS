...
namespace YellowstonePathology.Business.Test.TLE1
{
    public class TLE1Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public TLE1Test()
        {
            this.m_PanelSetId = 396;
            this.m_PanelSetName = "TLE1 (IHC)";
            this.m_Abbreviation = "TLE1";
