...
namespace YellowstonePathology.Business.Test.NeoTYPEMelanomaProfile
{
    public class NeoTYPEMelanomaProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeoTYPEMelanomaProfileTest()
        {
            this.m_PanelSetId = 355;
            this.m_PanelSetName = "NeoTYPE Melanoma Profile";
            this.m_Abbreviation = "NeoTYPE Melanoma Profile";
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("88377", null), 3);
