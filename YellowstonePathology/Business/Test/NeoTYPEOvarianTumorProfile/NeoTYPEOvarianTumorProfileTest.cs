...
namespace YellowstonePathology.Business.Test.NeoTypeOvarianTumorProfile
{
    public class NeoTypeOvarianTumorProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        ...
        public NeoTypeOvarianTumorProfileTest()
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("88377", null), 1);
