...
namespace YellowstonePathology.Business.Test.HER2BreastEquivocalFISHPanel
{
    public class HER2BreastEquivocalFISHPanelTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public HER2BreastEquivocalFISHPanelTest()
        {
