...
namespace YellowstonePathology.Business.Test.JAK29P241
{
    public class JAK29P241Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public JAK29P241Test()
        {
            this.m_PanelSetId = 384;
            this.m_PanelSetName = "JAK2 (9p24.1)";
            this.m_Abbreviation = "JAK2 (9p24.1)";
