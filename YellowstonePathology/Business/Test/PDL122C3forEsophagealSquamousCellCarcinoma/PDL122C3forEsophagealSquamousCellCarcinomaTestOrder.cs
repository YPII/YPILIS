...
{
    [PersistentClass("tblPDL122C3forEsophagealSquamousCellCarcinomaTestOrder", "tblPanelSetOrder", "YPIDATA")]
    public class PDL122C3forEsophagealSquamousCellCarcinomaTestOrder : PanelSetOrder
    {
        ...
        public PDL122C3forEsophagealSquamousCellCarcinomaTestOrder()
        {

        }

        public PDL122C3forEsophagealSquamousCellCarcinomaTestOrder(string masterAccessionNo, string reportNo, string objectId,
        ...
        {
            PDL122C3forEsophagealSquamousCellCarcinomaTestOrder panelSetOrder = (PDL122C3forEsophagealSquamousCellCarcinomaTestOrder)pso;
