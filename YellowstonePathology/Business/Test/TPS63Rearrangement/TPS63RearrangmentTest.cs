...
namespace YellowstonePathology.Business.Test.TPS63Rearrangement
{
    public class TPS63RearrangementTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public TPS63RearrangementTest()
        {
            this.m_PanelSetId = 383;
            this.m_PanelSetName = "TPS63 Rearrangement";
