...
{
    public class PDL122C3forNonsmallCellLungCancerEPICNTEView : Business.HL7View.EPIC.EPICBeakerObxView
    {
        public PDL122C3forNonsmallCellLungCancerEPICNTEView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int nteCount) 
