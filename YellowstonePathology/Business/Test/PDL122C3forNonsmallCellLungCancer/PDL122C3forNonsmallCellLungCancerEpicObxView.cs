...
{
    public class PDL122C3forNonsmallCellLungCancerEPICObxView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public PDL122C3forNonsmallCellLungCancerEPICObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        {
            PDL122C3forNonsmallCellLungCancerTestOrder panelSetOrder = (PDL122C3forNonsmallCellLungCancerTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
            this.AddHeader(document, panelSetOrder, "PD-L1 (22C3) for Non-small Cell Lung Cancer Analysis");
