...
namespace YellowstonePathology.Business.Test.NeoTYPEMyeloidDisordersProfile
{
    public class NeoTYPEMyeloidDisordersProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
