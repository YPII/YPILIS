...
{
    public class PDL122C3forUrothelialCarcinomaEpicObxView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public PDL122C3forUrothelialCarcinomaEpicObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        public override void ToXml(XElement document)
        {
            ...
            this.AddHeader(document, panelSetOrder, "PD-L1 (22C3) for Urothelial Carcinoma Analysis");
