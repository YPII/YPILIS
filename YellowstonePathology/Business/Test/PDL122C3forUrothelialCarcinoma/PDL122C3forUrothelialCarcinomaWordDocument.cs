...
{
    public class PDL122C3forUrothelialCarcinomaWordDocument : YellowstonePathology.Business.Document.CaseReportV2
    {
        public PDL122C3forUrothelialCarcinomaWordDocument(Business.Test.AccessionOrder accessionOrder, Business.Test.PanelSetOrder panelSetOrder, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
        ...
        {
            PDL122C3forUrothelialCarcinomaTestOrder testOrder = (PDL122C3forUrothelialCarcinomaTestOrder)this.m_PanelSetOrder;

            this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\PDL122C3forUrothelialCarcinoma.xml";
            base.OpenTemplate();
