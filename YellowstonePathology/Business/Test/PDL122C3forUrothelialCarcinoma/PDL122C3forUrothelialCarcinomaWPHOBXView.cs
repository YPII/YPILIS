...
{
    public class PDL122C3forUrothelialCarcinomaWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public PDL122C3forUrothelialCarcinomaWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
