...
{
    [PersistentClass("tblAMLNonFavorableRiskTestOrder", "tblPanelSetOrder", "YPIDATA")]
    public class AMLNonFavorableRiskTestOrder : YellowstonePathology.Business.Test.PanelSetOrder
    {
        ...
        public AMLNonFavorableRiskTestOrder(string masterAccessionNo, string reportNo, string objectId,
