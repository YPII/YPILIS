...
namespace YellowstonePathology.Business.Test.BRCA12MutationAnalysis
{
    public class BRCA12MutationAnalysisTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public BRCA12MutationAnalysisTest()
        {
            this.m_PanelSetId = 381;
            this.m_PanelSetName = "BRCA1/2 Mutation Analysis";
