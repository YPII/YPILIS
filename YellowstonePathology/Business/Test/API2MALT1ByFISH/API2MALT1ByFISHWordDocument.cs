...
namespace YellowstonePathology.Business.Test.API2MALT1ByFISH
{
	public class API2MALT1ByFISHWordDocument : YellowstonePathology.Business.Document.CaseReportV2
	{
        ...
        public override void Render()
		{
			...
			this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\API2MALT1ByFISH.3.xml";
			base.OpenTemplate();
            ...
            YellowstonePathology.Business.PanelSet.Model.PanelSet panelSet = Business.PanelSet.Model.PanelSetCollection.GetAll().GetPanelSet(this.m_PanelSetOrder.PanelSetId);
