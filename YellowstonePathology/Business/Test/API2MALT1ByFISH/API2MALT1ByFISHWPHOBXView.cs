...
{
    public class API2MALT1ByFISHWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public API2MALT1ByFISHWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
