...
namespace YellowstonePathology.Business.Test.PanTRK
{
    public class PanTRKTest :YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public PanTRKTest()
        {
            this.m_PanelSetId = 358;
            this.m_PanelSetName = "Pan-TRK";
            this.m_Abbreviation = "Pan-TRK";
