...
{
	public class MDSByFishEPICNTEView : YellowstonePathology.Business.HL7View.EPIC.EPICBeakerObxView
	{
		public MDSByFishEPICNTEView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
		...
		public override void ToXml(XElement document)
		{
            ...
            {
                this.AddNextNTEElement("", document);
                this.AddNextNTEElement("Probe Comments: " + panelSetOrder.ProbeComment, document);
            }
