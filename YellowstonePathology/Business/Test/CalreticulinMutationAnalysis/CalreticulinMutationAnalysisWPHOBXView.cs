...
{
    public class CalreticulinMutationAnalysisWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public CalreticulinMutationAnalysisWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
