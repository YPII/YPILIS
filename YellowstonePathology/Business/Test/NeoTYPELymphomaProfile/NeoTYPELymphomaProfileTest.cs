...
namespace YellowstonePathology.Business.Test.NeoTYPELumphomaProfile
{
    public class NeoTYPELumphomaProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
