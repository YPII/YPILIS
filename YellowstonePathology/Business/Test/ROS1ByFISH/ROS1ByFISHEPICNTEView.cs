...
{
	public class ROS1ByFISHEPICNTEView : YellowstonePathology.Business.HL7View.EPIC.EPICBeakerObxView
	{
        public ROS1ByFISHEPICNTEView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
