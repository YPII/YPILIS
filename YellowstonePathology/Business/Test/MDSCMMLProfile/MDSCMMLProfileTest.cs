...
namespace YellowstonePathology.Business.Test.MDSCMMLProfile
{
	public class MDSCMMLProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSetMolecularTest
	{
        public MDSCMMLProfileTest()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81450", null), 1);
