...
namespace YellowstonePathology.Business.Test.BladderCancerFISHUrovysion
{
	...
	{
        public BladderCancerFISHUrovysionWordDocument(Business.Test.AccessionOrder accessionOrder, Business.Test.PanelSetOrder panelSetOrder, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
		...
		{			
			...
			this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\BladderCancerFISHUrovysion.3.xml";
			base.OpenTemplate();
