...
{
    public class PDL122C3forTNBCBreastWordDocument : YellowstonePathology.Business.Document.CaseReportV2
    {
        public PDL122C3forTNBCBreastWordDocument(Business.Test.AccessionOrder accessionOrder, Business.Test.PanelSetOrder panelSetOrder, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
        ...
        {
            PDL122C3forTNBCBreastTestOrder testOrder = (PDL122C3forTNBCBreastTestOrder)this.m_PanelSetOrder;

            this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\PDL122C3forTNBCBreast.xml";
            base.OpenTemplate();
