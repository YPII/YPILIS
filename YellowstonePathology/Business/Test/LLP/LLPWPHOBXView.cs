...
{
    public class LLPWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public LLPWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
