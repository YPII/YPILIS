...
namespace YellowstonePathology.Business.Test.NUT
{
    public class NUTTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NUTTest()
        {
            this.m_PanelSetId = 335;
            this.m_PanelSetName = "NUT";
            this.m_Abbreviation = "NUT";
