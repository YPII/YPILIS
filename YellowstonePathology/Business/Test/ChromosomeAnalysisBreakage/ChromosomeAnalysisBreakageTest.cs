...
namespace YellowstonePathology.Business.Test.ChromosomeAnalysisBreakage
{
    public class ChromosomeAnalysisBreakageTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public ChromosomeAnalysisBreakageTest()
        {
            this.m_PanelSetId = 270;
            this.m_PanelSetName = "Chromosome Analysis Breakage";
            this.m_Abbreviation = "Chromosome Analysis Breakage";
