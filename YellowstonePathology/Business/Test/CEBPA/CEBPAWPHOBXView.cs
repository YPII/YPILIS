...
{
    public class CEBPAWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
    public CEBPAWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
