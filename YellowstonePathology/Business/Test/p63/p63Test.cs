...
namespace YellowstonePathology.Business.Test.p63
{
    public class p63Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public p63Test()
        {
            this.m_PanelSetId = 353;
            this.m_PanelSetName = "p63";
            this.m_Abbreviation = "p63";
