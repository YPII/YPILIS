...
{
    public class PDL122C3forGastricGEAWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public PDL122C3forGastricGEAWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
