...
{
    public class PDL122C3forGastricGEAEPICObxView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public PDL122C3forGastricGEAEPICObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        {
            PDL122C3forGastricGEATestOrder panelSetOrder = (PDL122C3forGastricGEATestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
            this.AddHeader(document, panelSetOrder, "PD-L1 (22C3) for Gastric/GEA Analysis");
