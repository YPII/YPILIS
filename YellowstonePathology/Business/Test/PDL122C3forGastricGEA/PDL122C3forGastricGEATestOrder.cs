...
{
    [PersistentClass("tblPDL122C3forGastricGEATestOrder", "tblPanelSetOrder", "YPIDATA")]
    public class PDL122C3forGastricGEATestOrder : PanelSetOrder
    {
        ...
        public PDL122C3forGastricGEATestOrder()
        {

        }

        public PDL122C3forGastricGEATestOrder(string masterAccessionNo, string reportNo, string objectId,
        ...
        {
            PDL122C3forGastricGEATestOrder panelSetOrder = (PDL122C3forGastricGEATestOrder)pso;
        ...
        public override Audit.Model.AuditResult IsOkToSetPreviousResults(PanelSetOrder panelSetOrder, AccessionOrder accessionOrder)
        {
            ...
            {
                PDL122C3forGastricGEATestOrder pdl122C3forGastricGEATestOrder = (PDL122C3forGastricGEATestOrder)panelSetOrder;
                this.DoesFinalSummaryResultMatch(accessionOrder, pdl122C3forGastricGEATestOrder.Result, result);
        ...
        private void DoesFinalSummaryResultMatch(AccessionOrder accessionOrder, string result, Audit.Model.AuditResult auditResult)
        {
            ...
            if (accessionOrder.PanelSetOrderCollection.Exists(egfrToALKReflexAnalysisTest.PanelSetId) == true)
            {
                ...
                egfrToALKReflexAnalysisTestOrder.DoesPDL122C3forGastricGEAResultMatch(result, auditResult);
            }
        }
    }
}
