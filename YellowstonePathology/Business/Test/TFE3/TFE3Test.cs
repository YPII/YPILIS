...
namespace YellowstonePathology.Business.Test.TFE3
{
    public class TFE3Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public TFE3Test()
        {
            this.m_PanelSetId = 351;
            this.m_PanelSetName = "TFE3";
            this.m_Abbreviation = "TFE3";
