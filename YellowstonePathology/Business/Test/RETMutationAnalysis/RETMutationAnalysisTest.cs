...
namespace YellowstonePathology.Business.Test.RETMutationAnalysis
{
    public class RETMutationAnalysisTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public RETMutationAnalysisTest()
        {
            this.m_PanelSetId = 258;
            this.m_PanelSetName = "RET Mutation Analysis";
            this.m_Abbreviation = "RET Mutation";
