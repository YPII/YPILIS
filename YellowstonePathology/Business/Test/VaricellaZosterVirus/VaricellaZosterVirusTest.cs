...
namespace YellowstonePathology.Business.Test.VaricellaZosterVirus
{
    public class VaricellaZosterVirusTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
