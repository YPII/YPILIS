...
{
    class AMLStandardByFishWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public AMLStandardByFishWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        public override void ToXml(XElement document)
        {
            ...
            this.AddHeader(document, panelSetOrder, "AML Standard by Fish Analysis");
