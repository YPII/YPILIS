...
{
	[PersistentClass("tblAMLStandardByFishTestOrder", "tblPanelSetOrder", "YPIDATA")]
	public class AMLStandardByFishTestOrder : YellowstonePathology.Business.Test.PanelSetOrder
	{
        ...
        public AMLStandardByFishTestOrder()
		{
		}

		public AMLStandardByFishTestOrder(string masterAccessionNo, string reportNo, string objectId,
