...
namespace YellowstonePathology.Business.Test.NeoTYPEColorectalTumorProfile
{
    public class NeoTYPEColorectalTumorProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeoTYPEColorectalTumorProfileTest()
        {
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode2 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81479", null), 1);
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode3 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("88377", null), 3);
