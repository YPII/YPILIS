...
{
    public class RASRAFPanelWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public RASRAFPanelWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
