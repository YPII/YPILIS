...
{
    public class PDL122C3forHeadandNeckEPICObxView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public PDL122C3forHeadandNeckEPICObxView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        {
            PDL122C3forHeadandNeckTestOrder panelSetOrder = (PDL122C3forHeadandNeckTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
            this.AddHeader(document, panelSetOrder, "PD-L1 (22C3) for Head and Neck Analysis");
