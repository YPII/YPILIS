...
{
    public class PDL122C3forHeadandNeckWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public PDL122C3forHeadandNeckWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
