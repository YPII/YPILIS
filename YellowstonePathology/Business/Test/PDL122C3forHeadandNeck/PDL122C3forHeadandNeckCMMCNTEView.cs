...
{
    public class PDL122C3forHeadandNeckCMMCNTEView : YellowstonePathology.Business.HL7View.CMMC.CMMCNteView
    {
        protected YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        protected string m_DateFormat = "yyyyMMddHHmm";
        protected string m_ReportNo;

        public PDL122C3forHeadandNeckCMMCNTEView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo)
        {
        ...
        public override void ToXml(XElement document)
        {
            ...
            this.AddNextNteElement("PD-L1 (22C3) for Head and Neck Analysis", document);
