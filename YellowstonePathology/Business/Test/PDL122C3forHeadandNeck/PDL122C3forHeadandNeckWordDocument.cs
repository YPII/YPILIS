...
{
    public class PDL122C3forHeadandNeckWordDocument : YellowstonePathology.Business.Document.CaseReportV2
    {
        public PDL122C3forHeadandNeckWordDocument(Business.Test.AccessionOrder accessionOrder, Business.Test.PanelSetOrder panelSetOrder, YellowstonePathology.Business.Document.ReportSaveModeEnum reportSaveMode) 
        ...
        {
            PDL122C3forHeadandNeckTestOrder testOrder = (PDL122C3forHeadandNeckTestOrder)this.m_PanelSetOrder;

            this.m_TemplateName = @"\\CFileServer\Documents\ReportTemplates\XmlTemplates\PDL122C3forHeadandNeckTestOrder.xml";
            base.OpenTemplate();
