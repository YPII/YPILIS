...
namespace YellowstonePathology.Business.Test.NeotypeEndometrialTumorProfile
{
    public class NeotypeEndometrialTumorProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeotypeEndometrialTumorProfileTest()
        {
            this.m_PanelSetId = 404;
            this.m_PanelSetName = "Neotype Endometrial Tumor Profile";
