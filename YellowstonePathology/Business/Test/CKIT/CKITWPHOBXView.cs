...
{
    public class CKITWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public CKITWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
