...
{
	[PersistentClass("tblNonHodgkinsLymphomaFISHPanelTestOrder", "tblPanelSetOrder", "YPIDATA")]
	public class NonHodgkinsLymphomaFISHPanelTestOrder : YellowstonePathology.Business.Test.PanelSetOrder
    {
