...
{
    public class ErPrSemiQuantitativeWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public ErPrSemiQuantitativeWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
        ...
        public override void ToXml(XElement document)
        {
            ...
            {
                this.AddNextObxElement(specimenOrder.FixationComment, document, "F");
            }
