...
namespace YellowstonePathology.Business.Test.CancerTYPEID
{
    public class CancerTYPEIDTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public CancerTYPEIDTest()
        {
            this.m_PanelSetId = 342;
            this.m_PanelSetName = "CancerTYPE ID";
            this.m_Abbreviation = "CancerTYPE ID";
