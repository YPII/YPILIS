...
namespace YellowstonePathology.Business.Test.NeoSITEMelanoma
{
    public class NeoSITEMelanomaTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeoSITEMelanomaTest()
        {
            this.m_PanelSetId = 349;
            this.m_PanelSetName = "NeoSITE Melanoma";
            this.m_Abbreviation = "NeoSITE Melanoma";
