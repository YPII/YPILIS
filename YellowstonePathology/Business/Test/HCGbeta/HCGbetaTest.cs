...
namespace YellowstonePathology.Business.Test.HCGbeta
{
    public class HCGbetaTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public HCGbetaTest()
        {
            this.m_PanelSetId = 399;
            this.m_PanelSetName = "HCG-beta (IHC)";
            this.m_Abbreviation = "HCG-beta";
