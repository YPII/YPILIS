...
namespace YellowstonePathology.Business.Test.Adenovirus
{
    public class AdenovirusTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public AdenovirusTest()
        {
            this.m_PanelSetId = 326;
            this.m_PanelSetName = "Adenovirus (IHC)";
            this.m_Abbreviation = "Adenovirus";
