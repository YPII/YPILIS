...
namespace YellowstonePathology.Business.Test.CarbonicAnhydraseIXCAIX
{
    public class CarbonicAnhydraseIXCAIXTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
