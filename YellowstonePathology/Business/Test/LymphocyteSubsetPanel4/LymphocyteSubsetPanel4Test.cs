...
namespace YellowstonePathology.Business.Test.LymphocyteSubsetPanel4
{
    public class LymphocyteSubsetPanel4Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public LymphocyteSubsetPanel4Test()
        {
            this.m_PanelSetId = 297;
            this.m_PanelSetName = "Lymphocyte Subset Panel 4";
            this.m_Abbreviation = "Lymphocyte Subset Panel 4";
