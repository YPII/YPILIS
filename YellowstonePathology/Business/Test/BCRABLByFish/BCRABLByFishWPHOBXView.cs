...
{
    public class BCRABLByFishWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public BCRABLByFishWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
