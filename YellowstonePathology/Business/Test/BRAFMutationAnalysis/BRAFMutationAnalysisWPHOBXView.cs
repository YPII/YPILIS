...
{
    public class BRAFMutationAnalysisWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public BRAFMutationAnalysisWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
