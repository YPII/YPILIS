...
{
    public class API2MALT1ByPCREPICOBXView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public API2MALT1ByPCREPICOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
