...
namespace YellowstonePathology.Business.Test.BCL2t1418ByPCR
{
	public class BCL2t1418ByPCRTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
        public BCL2t1418ByPCRTest()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81278", null), 1);
