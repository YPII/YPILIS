...
{
    public class CCNDIBCLIGHByPCREPICOBXView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public CCNDIBCLIGHByPCREPICOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        {
            CCNDIBCLIGHByPCRTestOrder panelSetOrder = (CCNDIBCLIGHByPCRTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(this.m_ReportNo);
