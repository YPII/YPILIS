...
namespace YellowstonePathology.Business.Task.Model
{
	public class TaskOrderCollection : ObservableCollection<TaskOrder>
	{
		...
		public static YellowstonePathology.Business.Rules.MethodResult AddDailyTaskOrderCytologySlideDisposal(int days, object writer)
		{
			...
			DateTime actionDate = Business.Gateway.AccessionOrderGateway.GetNewestDailyTaskOrderTaskDate(task.TaskId);
		...
		public static YellowstonePathology.Business.Rules.MethodResult AddDailyTaskOrderPOCReport(int weeks)
		{
			...
			DateTime actionDate = Business.Gateway.AccessionOrderGateway.GetNewestWeeklyTaskOrderTaskDate(task.TaskId);
