...
namespace YellowstonePathology.Business.ASCCPRule
{
    ...
    {        
        ...
        public override void FinalizePap(Woman woman, SpecimenAdequacy specimenAdequacy, ScreeningImpression screeningImpression)
        {
            ...
            if (screeningImpression.ResultCode == "01" || screeningImpression.ResultCode == "02")
            {
                if (woman.SpecimenAdequacy.ResultCode == "10")
                {
                    ...
                    if (woman.Age <= 29)
                    {
                        woman.HPVIsOrdered = false;
                        woman.GenotypingIsOrdered = false;
                ...
                else if(woman.SpecimenAdequacy.ResultCode == "11")
                {
        ...
        {            
            if(woman.HPVIsOrdered == true)
            {
                woman.HPVResult = result;
                if (result == "Positive")
                {
                    woman.GenotypingIsOrdered = true;
        ...
        {
            if (woman.GenotypingIsOrdered == true)
            {
