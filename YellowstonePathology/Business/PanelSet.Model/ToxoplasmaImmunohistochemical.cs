...
{
    public class ToxoplasmaImmunohistochemical : PanelSet
	{
        public ToxoplasmaImmunohistochemical()
		{
			this.m_PanelSetId = 426;
			this.m_PanelSetName = "Toxoplasma Immunohistochemical";
