...
{
	public class PanelSetArupFactorV : PanelSetMolecularTest
	{
		public PanelSetArupFactorV()
		{
			this.m_PanelSetId = 44;
			this.m_PanelSetName = "ARUP: FACV";
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81241", null), 1);
