...
namespace YellowstonePathology.Business.PanelSet.Model
{
	public class PanelSetHPV16 : PanelSetMolecularTest
	{
		public PanelSetHPV16()
		{
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("87621", null), 1);
