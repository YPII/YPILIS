...
{
	public class HighRiskHPVByISHTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
        public HighRiskHPVByISHTest()
		{
			this.m_PanelSetId = 199;
			this.m_PanelSetName = "High Risk HPV By ISH";
            this.m_Abbreviation = "HPVISH";
