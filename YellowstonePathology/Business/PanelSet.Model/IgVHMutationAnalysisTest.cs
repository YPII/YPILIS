...
{
	public class IgVHMutationAnalysisTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
        public IgVHMutationAnalysisTest()
		{
			this.m_PanelSetId = 193;
			this.m_PanelSetName = "IgVH Mutation Analysis";
            this.m_Abbreviation = "IGVH";
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81263", null), 1);
