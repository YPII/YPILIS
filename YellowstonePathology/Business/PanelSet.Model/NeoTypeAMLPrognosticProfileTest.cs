...
{
    public class NeoTypeAMLPrognosticProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeoTypeAMLPrognosticProfileTest()
        {
            this.m_PanelSetId = 435;
            this.m_PanelSetName = "NeoType AML Prognostic Profile";
