...
namespace YellowstonePathology.Business.HL7View.Panther
{
    ...
    {                        
        ...
        {            
            ...
            this.m_OrderedOnId = assay.GetOrderedOnId(accessionOrder, panelSetOrder);
        ...
        private XElement CreateDocument()
        {
            ...
            PantherORC orc = new PantherORC(this.m_SpecimenOrder, this.m_OrderedOnId, this.m_PanelSetOrder, this.m_ActionCode);
            orc.ToXml(document);
