...
namespace YellowstonePathology.Business.HL7View.WYDOH
{
	public class WYDOHMSHViewV2
	{
		...
		public WYDOHMSHViewV2(Hl7Client client, Hl7MessageType messageType)
		{
        ...
        public void ToXml(XElement document)
        {
            ...
            XElement msh0302Element = new XElement("MSH.3.2", OID);
            msh03Element.Add(msh0301Element);
            msh03Element.Add(msh0302Element);
