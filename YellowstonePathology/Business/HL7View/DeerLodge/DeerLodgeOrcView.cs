...
namespace YellowstonePathology.Business.HL7View.DeerLodge
{
	...
	{        		
        ...
        public DeerLodgeOrcView(string externalOrderId, string secondaryExternalOrderid, YellowstonePathology.Business.Domain.Physician orderingPhysician, string masterAccessionNo, OrderStatus orderStatus, string systemInitiatingOrder, bool sendUnsolicited)
        {
        ...
        public void ToXml(XElement document)
        {
            ...
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("ORC.2.2", "EPC", orc02Element);
            ...
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("ORC.4.1", this.m_SecondaryExternalOrderid, orc04Element);
