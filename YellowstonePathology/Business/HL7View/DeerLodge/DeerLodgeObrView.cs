...
namespace YellowstonePathology.Business.HL7View.DeerLodge
{
	...
	{        
        ...
        public DeerLodgeObrView(string externalOrderId, string secondaryExternalOrderId, string masterAccessionNo, string reportNo, Nullable<DateTime> collectionDate, Nullable<DateTime> collectionTime, Nullable<DateTime> accessionTime, Nullable<DateTime> finalTime,
        ...
        {            
            ...
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.2.2", "EPC", obr02Element);
            obrElement.Add(obr02Element);                            

            XElement obr03Element = new XElement("OBR.3");
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.3.1", this.m_SecondaryExternalOrderId, obr03Element);
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.3.2", "Beaker", obr03Element);
            obrElement.Add(obr03Element);            
            
            //LAB1750^SURGICAL PATHOLOGY EXAM^BEAKER EAP^^SURG PATH

            string obr41 = string.Empty;
            string obr42 = string.Empty;
            string obr44 = string.Empty;

            if (m_PanelSetId == 13)
            {
                obr41 = "LAB1750";
                obr42 = "SURGICAL PATHOLOGY EXAM";
                obr44 = "SURG PATH";
            }
            ...
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.4.1", obr41, obr04Element);
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.4.2", obr42, obr04Element);
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.4.3", string.Empty, obr04Element);
            YellowstonePathology.Business.Helper.XmlDocumentHelper.AddElement("OBR.4.4", obr44, obr04Element);            
