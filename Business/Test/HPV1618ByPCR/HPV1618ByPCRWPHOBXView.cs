...
{
    public class HPV1618ByPCRWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public HPV1618ByPCRWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
