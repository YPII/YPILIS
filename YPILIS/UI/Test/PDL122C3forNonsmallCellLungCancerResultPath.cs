...
{
    public class PDL122C3forNonsmallCellLungCancerResultPath : ResultPath
    {
        PDL122C3forNonsmallCellLungCancerResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3forNonsmallCellLungCancer.PDL122C3forNonsmallCellLungCancerTestOrder m_PanelSetOrder;

        public PDL122C3forNonsmallCellLungCancerResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3forNonsmallCellLungCancer.PDL122C3forNonsmallCellLungCancerTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL122C3forNonsmallCellLungCancerResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL122C3forNonsmallCellLungCancerResultPage.NextEventHandler(ResultPage_Next);
