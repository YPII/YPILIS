...
{
    public class WYDOHResultViewV2 : IResultView
    {
        ...
        public WYDOHResultViewV2(string reportNo, YellowstonePathology.Business.Test.AccessionOrder accessionOrder)
        {
        ...
        {                        
            ...
            WYDOHMSHViewV2 msh = new WYDOHMSHViewV2(client, messageType);
            ...
            string mirthFileName = mirthFileName = @"\\apsinterface\ChannelData\WYFI\Outgoing\" + this.m_PanelSetOrder.ReportNo + ".Mirth.xml";
