...
namespace YellowstonePathology.Business.Test.NeoTYPELiposarcomaFusionProfile
{
    public class NeoTYPELiposarcomaFusionProfileTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
