...
{
    public class PDL122C3forGastricGEAEPICNTEView : YellowstonePathology.Business.HL7View.EPIC.EPICBeakerObxView
    {
        public PDL122C3forGastricGEAEPICNTEView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
        ...
        public override void ToXml(XElement document)
        {
            ...
            this.AddNextNTEElement(panelSetOrder.ReportNo, document);
