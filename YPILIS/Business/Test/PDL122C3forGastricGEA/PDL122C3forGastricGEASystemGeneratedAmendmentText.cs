...
{
    public class PDL122C3forGastricGEASystemGeneratedAmendmentText
    {
        public PDL122C3forGastricGEASystemGeneratedAmendmentText()
        {
        }

        public static string AmendmentText(PDL122C3forGastricGEA.PDL122C3forGastricGEATestOrder testOrder)
        {
