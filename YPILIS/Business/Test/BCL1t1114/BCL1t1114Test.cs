...
namespace YellowstonePathology.Business.Test.BCL1t1114
{
	public class BCL1t1114Test : YellowstonePathology.Business.PanelSet.Model.FISHTest
	{
        public BCL1t1114Test()
		{
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81168", null), 1);
