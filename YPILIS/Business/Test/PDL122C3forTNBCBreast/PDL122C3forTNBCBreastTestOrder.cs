...
{                      
    [PersistentClass("tblPDL122C3forTNBCBreastTestOrder", "tblPanelSetOrder", "YPIDATA")]
    public class PDL122C3forTNBCBreastTestOrder : PanelSetOrder
    {
        ...
        public PDL122C3forTNBCBreastTestOrder()
        {

        }

        public PDL122C3forTNBCBreastTestOrder(string masterAccessionNo, string reportNo, string objectId,
        ...
        {
            PDL122C3forTNBCBreastTestOrder panelSetOrder = (PDL122C3forTNBCBreastTestOrder)pso;
        ...
        public override Audit.Model.AuditResult IsOkToSetPreviousResults(PanelSetOrder panelSetOrder, AccessionOrder accessionOrder)
        {
            ...
            {
                PDL122C3forTNBCBreastTestOrder pdl122C3forNonsmallCellLungCancerTestOrder = (PDL122C3forTNBCBreastTestOrder)panelSetOrder;
