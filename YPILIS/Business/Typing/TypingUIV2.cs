    ...
    public class TypingUIV2 : INotifyPropertyChanged
    {
        ...
        public YellowstonePathology.Business.Amendment.Model.AmendmentCollection AmendmentCollection
        {
            get
            {
                if(this.m_AccessionOrder != null)
                {
                    return this.m_AccessionOrder.AmendmentCollection.GetAmendmentsForReport(this.m_SurgicalTestOrder.ReportNo);
                }
                return new Amendment.Model.AmendmentCollection();
            }
        }
