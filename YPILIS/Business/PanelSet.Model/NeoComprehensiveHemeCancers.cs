...
{
    public class NeoComprehensiveHemeCancers : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public NeoComprehensiveHemeCancers()
        {
            this.m_PanelSetId = 446;
            this.m_PanelSetName = "Neo Comprehensive Heme Cancers";
