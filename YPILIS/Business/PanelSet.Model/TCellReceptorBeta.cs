...
{
    public class TCellReceptorBetaTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public TCellReceptorBetaTest()
        {
            this.m_PanelSetId = 438;
            this.m_PanelSetName = "T-Cell Receptor Beta";
