...
{
    public class PDL122C3forEsophagealSquamousCellCarcinomaResultPath : ResultPath
    {
        PDL122C3forEsophagealSquamousCellCarcinomaResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3forEsophagealSquamousCellCarcinoma.PDL122C3forEsophagealSquamousCellCarcinomaTestOrder m_PanelSetOrder;

        public PDL122C3forEsophagealSquamousCellCarcinomaResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3forEsophagealSquamousCellCarcinoma.PDL122C3forEsophagealSquamousCellCarcinomaTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL122C3forEsophagealSquamousCellCarcinomaResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL122C3forEsophagealSquamousCellCarcinomaResultPage.NextEventHandler(ResultPage_Next);
