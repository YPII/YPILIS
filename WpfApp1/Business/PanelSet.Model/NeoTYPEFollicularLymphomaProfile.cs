...
{
    public class NeoTYPEFollicularLymphomaProfile  : PanelSet
	{
        public NeoTYPEFollicularLymphomaProfile()
		{
			this.m_PanelSetId = 425;
			this.m_PanelSetName = "NeoTYPE Follicular Lymphoma Profile";
