        ...
        private void LoadDirectory()
        {
            ...
            switch (this.m_DictationLocation)
            {
                case DictationLocationEnum.Local:                    
                    this.LoadDirectory(Properties.Settings.Default.LocalDictationFolder);
                    break;
                case DictationLocationEnum.Server:
                    foreach (DirectoryInfo d in new DirectoryInfo(Properties.Settings.Default.ServerDictationFolder).GetDirectories())
                    {
