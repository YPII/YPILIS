...
{
	[PersistentClass("tblEosinophiliaByFISHTestOrder", "tblPanelSetOrder", "YPIDATA")]
	public class EosinophiliaByFISHTestOrder : YellowstonePathology.Business.Test.PanelSetOrder
	{
        ...
        public EosinophiliaByFISHTestOrder()
		{
		}

		public EosinophiliaByFISHTestOrder(string masterAccessionNo, string reportNo, string objectId,
