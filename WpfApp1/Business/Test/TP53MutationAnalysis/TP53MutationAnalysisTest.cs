...
namespace YellowstonePathology.Business.Test.TP53MutationAnalysis
{
    public class TP53MutationAnalysisTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
...
this.m_ImplementedResultTypes.Add(Business.Test.ResultType.REFLAB);
            ...
            YellowstonePathology.Business.Billing.Model.PanelSetCptCode panelSetCptCode1 = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81352", null), 1);
