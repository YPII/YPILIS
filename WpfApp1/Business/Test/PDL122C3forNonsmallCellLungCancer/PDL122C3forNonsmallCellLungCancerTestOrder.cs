...
{
    [PersistentClass("tblPDL122C3forNonsmallCellLungCancerTestOrder", "tblPanelSetOrder", "YPIDATA")]
    public class PDL122C3forNonsmallCellLungCancerTestOrder : PanelSetOrder
    {
        ...
        public PDL122C3forNonsmallCellLungCancerTestOrder()
        {

        }

        public PDL122C3forNonsmallCellLungCancerTestOrder(string masterAccessionNo, string reportNo, string objectId,
        ...
        {
            PDL122C3forNonsmallCellLungCancerTestOrder panelSetOrder = (PDL122C3forNonsmallCellLungCancerTestOrder)pso;
        ...
        public override Audit.Model.AuditResult IsOkToSetPreviousResults(PanelSetOrder panelSetOrder, AccessionOrder accessionOrder)
        {
            ...
            {
                PDL122C3forNonsmallCellLungCancerTestOrder pdl122C3forNonsmallCellLungCancerTestOrder = (PDL122C3forNonsmallCellLungCancerTestOrder)panelSetOrder;
                this.DoesFinalSummaryResultMatch(accessionOrder, pdl122C3forNonsmallCellLungCancerTestOrder.Result, result);
