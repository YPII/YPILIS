...
namespace YellowstonePathology.Business.Test.ALLFISHPanel
{
    public class ALLFISHPanelTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public ALLFISHPanelTest()
        {
            this.m_PanelSetId = 403;
            this.m_PanelSetName = "ALL FISH Panel (Ph-Like)";
