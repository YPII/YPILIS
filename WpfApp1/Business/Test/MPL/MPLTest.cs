...
namespace YellowstonePathology.Business.Test.MPL
{
	public class MPLTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
	{
		public MPLTest()
		{
			...
			this.m_PanelSetName = "MPL Mutation Analysis (Molecular)";
            ...
            Business.Billing.Model.PanelSetCptCode panelSetCptCode = new YellowstonePathology.Business.Billing.Model.PanelSetCptCode(Store.AppDataStore.Instance.CPTCodeCollection.GetClone("81339", null), 1);
