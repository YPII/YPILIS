...
namespace YellowstonePathology.Business.HL7View.NMH
{
	public class NMHMSHView
    {
		...
		public NMHMSHView(Hl7Client client, Hl7MessageType messageType, string locationCode)
		{
        ...
        public void ToXml(XElement document)
        {
            ...
            XElement msh0301Element = new XElement("MSH.3.1", "PTH");
