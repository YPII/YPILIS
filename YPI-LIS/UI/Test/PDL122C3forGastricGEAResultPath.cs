...
{
    public class PDL122C3forGastricGEAResultPath : ResultPath
    {
        PDL122C3forGastricGEAResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3forGastricGEA.PDL122C3forGastricGEATestOrder m_PanelSetOrder;

        public PDL122C3forGastricGEAResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3forGastricGEA.PDL122C3forGastricGEATestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL122C3forGastricGEAResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL122C3forGastricGEAResultPage.NextEventHandler(ResultPage_Next);
