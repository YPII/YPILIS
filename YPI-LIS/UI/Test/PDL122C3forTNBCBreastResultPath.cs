...
{
    public class PDL122C3forTNBCBreastResultPath : ResultPath
    {
        PDL122C3forTNBCBreastResultPage m_ResultPage;
        YellowstonePathology.Business.Test.AccessionOrder m_AccessionOrder;
        YellowstonePathology.Business.Test.PDL122C3forTNBCBreast.PDL122C3forTNBCBreastTestOrder m_PanelSetOrder;

        public PDL122C3forTNBCBreastResultPath(string reportNo,
            ...
            : base(pageNavigator, window)
        {
            ...
            this.m_PanelSetOrder = (YellowstonePathology.Business.Test.PDL122C3forTNBCBreast.PDL122C3forTNBCBreastTestOrder)this.m_AccessionOrder.PanelSetOrderCollection.GetPanelSetOrder(reportNo);
        }

        protected override void ShowResultPage()
        {
            this.m_ResultPage = new PDL122C3forTNBCBreastResultPage(this.m_PanelSetOrder, this.m_AccessionOrder, this.m_SystemIdentity);
            this.m_ResultPage.Next += new PDL122C3forTNBCBreastResultPage.NextEventHandler(ResultPage_Next);
