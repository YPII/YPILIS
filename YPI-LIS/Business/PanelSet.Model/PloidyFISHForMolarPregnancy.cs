...
{
    public class PloidyFISHForMolarPregnancy : PanelSet
	{
        public PloidyFISHForMolarPregnancy()
		{
			this.m_PanelSetId = 418;
			this.m_PanelSetName = "Ploidy FISH for Molar Pregnancy";
            ...
            this.m_TaskCollection.Add(new YellowstonePathology.Business.Task.Model.TaskFedexShipment(YellowstonePathology.Business.Task.Model.TaskAssignment.Flow, "Gather H&E slide and paraffin block and deliver to Flow for sendout to NEO.", neogenomicsIrvine));
