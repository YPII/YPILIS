...
{
	public class EPICBeakerMshView
	{
		...
		public EPICBeakerMshView(Hl7Client client, Hl7MessageType messageType, string locationCode)
		{
        ...
        public void ToXml(XElement document)
        {
            ...
            XElement msh0401Element = new XElement("MSH.4.1", "YPIILIS");                        
