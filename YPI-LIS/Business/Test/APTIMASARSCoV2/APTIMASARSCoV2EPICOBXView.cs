...
{
	public class APTIMASARSCoV2EPICOBXView : YellowstonePathology.Business.HL7View.EPIC.EPICBeakerObxView
    {
		public APTIMASARSCoV2EPICOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
        ...
        {            
            ...
            if (panelSetOrder.Result == "POSITIVE") isCritical = true;
