...
{
    public class MPNFishWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public MPNFishWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
