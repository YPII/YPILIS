...
{
    public class InvasiveBreastPanelEPICOBXView : YellowstonePathology.Business.HL7View.EPIC.EPICObxView
    {
        public InvasiveBreastPanelEPICOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
