...
{
    public class LynchSyndromeEvaluationWPHOBXView : HL7View.WPH.WPHOBXView
    {
        public LynchSyndromeEvaluationWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
