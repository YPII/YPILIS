...
namespace YellowstonePathology.Business.Test.HER2Other
{
    public class HER2OtherTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public HER2OtherTest()
        {
            this.m_PanelSetId = 406;
            this.m_PanelSetName = "HER2 Other";
