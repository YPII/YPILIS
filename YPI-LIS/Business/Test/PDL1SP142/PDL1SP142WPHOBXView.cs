...
{
    public class PDL1SP142WPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public PDL1SP142WPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
