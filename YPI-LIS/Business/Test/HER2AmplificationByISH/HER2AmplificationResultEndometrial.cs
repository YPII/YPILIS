...
{
    public class HER2AmplificationResultEndometrial : HER2AmplificationResult
    {

        public HER2AmplificationResultEndometrial(PanelSetOrderCollection panelSetOrderCollection, HER2AmplificationByISHTestOrder panelSetOrder) : base(panelSetOrderCollection, panelSetOrder)
        {
        ...
        {
            bool result = false;
            if (this.m_HER2AmplificationByISHTestOrder.Indicator == HER2AmplificationByISHIndicatorCollection.EndometrialIndication) result = true;
            return result;
        }
