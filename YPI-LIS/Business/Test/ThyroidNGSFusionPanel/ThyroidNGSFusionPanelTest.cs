...
namespace YellowstonePathology.Business.Test.ThyroidNGSFusionPanel
{
    public class ThyroidNGSFusionPanelTest : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public ThyroidNGSFusionPanelTest()
        {
            this.m_PanelSetId = 402;
            this.m_PanelSetName = "Thyroid NGS Fusion Panel";
