...
namespace YellowstonePathology.Business.Test.CDK4
{
    public class CDK4Test : YellowstonePathology.Business.PanelSet.Model.PanelSet
    {
        public CDK4Test()
        {
            this.m_PanelSetId = 397;
            this.m_PanelSetName = "CDK4 (IHC)";
            this.m_Abbreviation = "CDK4";
