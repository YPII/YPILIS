...
{
    public class NPM1WPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public NPM1WPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
