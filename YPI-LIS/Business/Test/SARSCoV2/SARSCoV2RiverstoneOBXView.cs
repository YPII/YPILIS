...
{
	public class SARSCoV2RiverstoneOBXView : Business.HL7View.Riverstone.RiverstoneOBXView
    {
		public SARSCoV2RiverstoneOBXView(Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
