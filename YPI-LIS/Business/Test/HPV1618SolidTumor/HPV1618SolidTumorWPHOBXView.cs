...
{
    public class HPV1618SolidTumorWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public HPV1618SolidTumorWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount) 
