...
{
    public class BCellSubsetAnalysisWPHOBXView : YellowstonePathology.Business.HL7View.WPH.WPHOBXView
    {
        public BCellSubsetAnalysisWPHOBXView(YellowstonePathology.Business.Test.AccessionOrder accessionOrder, string reportNo, int obxCount)
